...
class FeedWordPressCompatibility {
	 ...
	 * 	or too high.
	 */
	public static function test_version ($floor, $ceiling = null) {
	...
	public static function insert_link_category ($name) {
		global $wpdb;
	...
	public static function link_category_id ($value, $key = 'cat_name') {
		global $wpdb;
	...
	public static function validate_http_request ($action = -1, $capability = null) {
	...
	public static function stamp_nonce ($action = -1) {
	...
	public static function bottom_script_hook ($filename) {
		global $fwp_path;
